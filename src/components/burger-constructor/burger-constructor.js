...
export default class BurgerConstructor extends React.Component {
    ...
    IngredientsList = () => {
        return (
            <ul className='constructor__list'>
                <li className='constructor__item-list'>
                    <ConstructorElement
                        type="top"
                        isLocked={true}
    ...
    render() {
        return (
            <section className='constructor mt-25'>

                <this.IngredientsList />
                <div className='constructor__content-bottom mt-10'>
                    <div className='constructor__block-amount mr-10'>
                        <p className="text text_type_digits-medium constructor__text-amount">610</p>
